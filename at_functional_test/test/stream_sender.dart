...
void main() async {
  try {
    var first_atsign = ConfigUtil.getYaml()['first_atsign_server']['first_atsign_name'];
    var second_atsign = ConfigUtil.getYaml()['second_atsign_server']['second_atsign_name'];
    ...
    await atClient.startMonitor(
        ...
        null);
    var streamResult = await atClient.stream('$first_atsign', 'samples/download.jpeg',
...
AtClientPreference getsecondAtsignPreference(String atsign) {
  ...
  preference.rootDomain = ConfigUtil.getYaml()['second_atsign_server']['second_atsign_name'];;
  return preference;
}
