...
void main() {
  ...
  var third_atsign = '@judicialabseiling';
  ...
  test('notify all for notifiying 2 atsigns at the same time for a delete ',
    ...
    await socket_writer(_socket_second_atsign, 'notify:list:facebook');
    response = await read();    print('notify list verb response : $response');
    expect(
        response,
        contains(
